...
//! a worktree of its own until ADR-0082) — and each imposes its own alphabet, its own length, and its own
...
mod tests {
    ...
    /// was declared before ADR-0082 stopped the plugin creating worktrees.
