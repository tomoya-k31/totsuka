...
pub struct TaskDispatchParams {
    ...
    /// agents that declare none (the mock; orca, until ADR-0081). That difference is the whole reason this field is not
    ...
    /// (as orca did before ADR-0081, driving the `orca` CLI itself) keeps a wide
