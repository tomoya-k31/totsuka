...
timestamp: 2026-07-26T01:00:00+09:00
status: active
owner: tomoya-k31
---
...
| `version` | `PROTOCOL_VERSION`（アプリ本体と独立、§10.2）と互換判定 `is_compatible`（F-54）。現行 **0.2.4** |
